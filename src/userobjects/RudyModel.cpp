#include "RudyModel.hpp"

registerObjectCpp(RudyModel);

RudyModel::RudyModel(Problem * problem, hit::Node * params)
...
ADRankTwoTensor
RudyModel::PK2(const ADRankTwoTensor & F, void * context) const
{
  // Identity tensor
  ADRankTwoTensor I2;
  I2.setIdentity();
